        ...
        <div class="main">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    foreach($leads as $s):?>
                    <tr id="contentrow_<?=$s->lead_id?>">
                        <td>
                            <a class="pull-left" href="<?=site_url("dashboard/edit_lead/".$s->lead_id)?>"><span class="btn btn-default  glyphicon glyphicon-pencil"></span></a>
                            <a class="pull-right deletebtn" href="#"  data-contentid="<?=$s->lead_id?>"><span class="btn  btn-default glyphicon glyphicon-trash"></span></a>
                        </td>
                        <td><?=$s->lead_id?></td>
                        <td><?=$s->fname?></td>
                        <td><?=$s->lname?></td>

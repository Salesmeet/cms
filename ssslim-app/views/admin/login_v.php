...
<div class="container">
        <div class="row logoWrp">
            <a href="<?= base_url() ?>"><span style="color: white; font-size: 30px; font-weight: bold">Your Clouds Can</span><?/*<img src="<?= base_url() ?>images/logo.png">*/?></a>
        </div>
    <div class="jumbotron">
        <h1>Welcome!</h1>
